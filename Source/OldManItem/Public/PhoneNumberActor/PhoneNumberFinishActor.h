...
#include "PhoneNumberFinishActor.generated.h"

/**
 * 
 */
UCLASS(Blueprintable)
class OLDMANITEM_API APhoneNumberFinishActor : public AOldManInterectItemBase
{
	GENERATED_BODY()
	
public:
	UFUNCTION(BlueprintCallable)
	void BeTriggered(bool Immediately);

	UFUNCTION(BlueprintImplementableEvent, Category = "OnTrigger")
	void OnTrigger();
